...
//public class JdbcConAdviceTest extends BaseSnifferTest {
...
//            Definition.Default def = new GenJdbcConAdvice().define(Definition.Default.EMPTY);
//            ClassLoader loader = this.getClass().getClassLoader();
//            classList = Classes.transform(this.getClass().getName() + "$MyConnection")
//                    .with(def,
//                            new QualifiedBean("supplier4JdbcCon", this.mockSupplier()),
...
//        MyConnection con = (MyConnection) classList.get(0).newInstance();
...
//
//    @Test
//    public void setAutoCommit_fail() throws Exception {
//        MyConnection con = (MyConnection) classList.get(0).newInstance();
