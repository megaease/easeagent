...
public abstract class RabbitPropertiesAdvice implements Transformation {
    ...
    public <T extends Definition> T define(Definition<T> def) {
        return def
            .type(named("org.springframework.boot.autoconfigure.amqp.RabbitProperties"))
    ...
    public abstract Definition.Transformer setProperty(ElementMatcher<? super MethodDescription> matcher);

    static class SetProperty extends AbstractAdvice {
        @Injection.Autowire
        public SetProperty(@Injection.Qualifier("supplier4RabbitPropertiesSetProperty") Supplier<AgentInterceptorChain.Builder> supplier,
