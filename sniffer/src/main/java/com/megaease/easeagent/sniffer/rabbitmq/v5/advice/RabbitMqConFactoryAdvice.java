...
public abstract class RabbitMqConFactoryAdvice implements Transformation {
    ...
    public <T extends Definition> T define(Definition<T> def) {
        return def
                .type(hasSuperType(named("com.rabbitmq.client.ConnectionFactory")))
    ...
    static class SetProperty extends AbstractAdvice {
        @Injection.Autowire
        public SetProperty(@Injection.Qualifier("supplier4RabbitMqSetProperty") Supplier<AgentInterceptorChain.Builder> supplier,
