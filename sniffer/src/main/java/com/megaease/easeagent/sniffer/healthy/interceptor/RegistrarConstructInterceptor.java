...
public class RegistrarConstructInterceptor implements AgentInterceptor {

    private final AgentHealth agentHealth;

    public RegistrarConstructInterceptor(AgentHealth agentHealth) {
        this.agentHealth = agentHealth;
    }

    @Override
    public Object after(MethodInfo methodInfo, Map<Object, Object> context, AgentInterceptorChain chain) {
        agentHealth.setReadinessEnabled(true);
