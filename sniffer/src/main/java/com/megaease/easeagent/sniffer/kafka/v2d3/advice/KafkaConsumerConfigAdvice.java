...
public abstract class KafkaConsumerConfigAdvice implements Transformation {
    ...
    static class ObjConstruct extends AbstractAdvice {
        ...
        public ObjConstruct(AgentInterceptorChainInvoker chainInvoker,
                            @Injection.Qualifier("supplier4KafkaConsumerConfigConstructor") Supplier<AgentInterceptorChain.Builder> supplier) {
        ...
        public ForwardLock.Release<Map<Object, Object>> enter(
            ...
            return this.doEnter(null, method, args);
        }
