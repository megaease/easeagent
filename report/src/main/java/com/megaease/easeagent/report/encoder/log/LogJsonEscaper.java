...
/**
 * borrow from zipkin2.internal.JsonEscaper, replace \t with spaces
 * for loggerSender(base on log4j2) can't print json string with \\t
 */
public final class LogJsonEscaper {
